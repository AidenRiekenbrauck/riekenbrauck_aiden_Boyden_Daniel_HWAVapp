            ...
            <div class="row"> <!-- 2-up for nav and media info -->
                <div class="media-info center">
                    ...
                    <div class="thumbs-wrapper clearfix" style="border: 60px solid black;width: 100vw;" >
                        ...
                        <div class="audioThumbSize">
                            <img v-if="activeMediaType == 'audio'" v-for="media in retrievedMedia" :src="'images/audio/' + media.audio_cover" alt="media thumb" @click="switchActiveMedia(media)" class="img-thumbnail rounded center-block media-thumb audio-thumb">
                        </div>
                    </div>
                </div>
            </div>       
